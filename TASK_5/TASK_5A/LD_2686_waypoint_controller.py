...
class DroneController():
    def __init__(self,node):
        ...
        self.waypoint = [[0,0,23],[2,3,23],[-1,2,25],[-3,-3,25],[0,0,27]]
        
        self.current_waypoint_indx=0
        self.setpoint = self.waypoint[self.current_waypoint_indx]        # Setpoints for x, y, z respectively      
...
#
    ...
    def next(self):
        ...
        #    pass
        #self.Base_z=10
        current_setpoint =self.drone_position[2]
    ...
    def landing(self):
        ...
        #while time.tme() - start_time < 2:
        #    self.rc_message.rc_pitch = 1492.5
        #    self.rc_message.rc_roll = 1502.5
